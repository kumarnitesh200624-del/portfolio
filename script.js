...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const aiKnowledgeBase = {
    ...
    education: `🎓 Nitesh is pursuing his <strong>Bachelor of Computer Applications (BCA)</strong> at <strong>Lovely Professional University (LPU)</strong>, Punjab (Aug 2025 – Present).<br>• Intermediate (Class XII): <strong>81.66%</strong><br>• Matriculation (Class X): <strong>76.66%</strong>`,
